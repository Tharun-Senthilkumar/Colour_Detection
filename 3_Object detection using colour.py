...
while True:
        ...
        (_, frame) = camera.read() #reading frame from camera
        ...
        mask = cv2.inRange(hsv, hsvLower, hsvUpper) #mask the directed color
        mask = cv2.erode(mask, None, iterations=2)#erosion and dilation to overcome the left area
